    ...
    <Card className="w-full max-w-[17rem] mx-auto bg-white shadow-sm hover:shadow-md transition-shadow duration-200 border border-gray-200">
      <CardHeader className="text-center p-6 pb-4">
        ...
        {isTenderPage ? (
          ...
          <Button
            className={`max-w-60 mx-auto hover:bg-gray-400 text-white font-medium ${respondedToJob
                ? "bg-gray-500 cursor-not-allowed"
                : "button-gradient"
              }`}
            onClick={
          ...
          >
            {respondedToJob
              ...
              : jobTenderSidebarTranslations.applyButtonText || "Apply for this Position"}
          </Button>
        ) : null}

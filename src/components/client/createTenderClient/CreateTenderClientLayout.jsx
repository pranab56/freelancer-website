...
function CreateTenderClientLayout() {
  ...
  // Handle tender description from TipTap - FIXED with useCallback
  ...
  // CreateTenderTopForm Component - useMemo to prevent recreation
  ...
  // TenderDescription Component - useMemo to prevent recreation

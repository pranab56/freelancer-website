			...
			<div className="relative z-10 flex items-center justify-center h-full px-6">
				<div className="text-center  lg:min-w-7xl  mx-auto">
					...
					<div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
						<Button
							size="lg"
							className="bg-white text-black hover:bg-gray-100 font-semibold px-8 py-4 text-lg rounded-full min-w-[250px] h-12">
							Find Freelance Talent
							<span className="ml-2 text-sm text-gray-600">(For Clients)</span>
						</Button>

						<Button
							size="lg"
							variant="outline"
							className="border-white text-white hover:bg-white hover:text-black font-semibold px-8 py-4 text-lg rounded-full min-w-[250px] bg-transparent h-12">
							Apply to Join
							<span className="ml-2 text-sm opacity-80">(For Freelancers)</span>
						</Button>
					</div>
				</div>
			</div>

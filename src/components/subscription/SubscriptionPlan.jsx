      ...
      const subscriptionPlansFreelancer = [
        {
          ...
          features: [
            subscriptionPlanTranslations.freelancer?.starterPlan?.features?.[
              "1"
        ...
        },
        {
          id: 3,
          title:
            subscriptionPlanTranslations.freelancer?.proPlan?.title ||
            "Pro plan",
          icon: "⭐",
          fee: 12,
          duration: subscriptionPlanTranslations.duration?.month || "mo",
      ...
      const subscriptionPlansClient = [
        {
          ...
          duration: subscriptionPlanTranslations.duration?.month || "mo",
          features: [
            subscriptionPlanTranslations.client?.businessPlan?.features?.[
              "1"
            ] || "5 tenders/month",
            subscriptionPlanTranslations.client?.businessPlan?.features?.[
              "2"
        ...
        },
        {
          ...
          duration: subscriptionPlanTranslations.duration?.month || "mo",
          features: [
            subscriptionPlanTranslations.client?.enterprisePlan?.features?.[
              "1"
            ] || "Unlimited tenders",
            subscriptionPlanTranslations.client?.enterprisePlan?.features?.[
              "2"
...
function SubscriptionPlan() {
  // Get translations from Redux outside the dynamic component
